							...
							return (
								<Card className="m-3 flex-1 p-5" key={flight.FlightId}>
									...
									<div className="m-3 flex items-center space-x-3">
										...
										<Progress
											key={flight.FlightId}
											value={calculateProgress(flight)}
										/>
										<PlaneLanding />
									</div>
									<hr />
									<div className="m-3">
										...
										<p>
											{dayjs(flight.DepartureTimeEpochMs).format(
									...
									<div className="m-3">
										...
										<p>
											{dayjs(flight.ArrivalTimeEpochMs).format(
												'MMM D YYYY h:mm:ss A',
											)}
									...
									<div>
										...
										<p>
											Arrival Time:{' '}
											{new Date(flight.ArrivalTimeEpochMs).toLocaleString()}
										</p>
												...
												return (
													<div key={index}>
														...
														<p>
															Departure Time:{' '}
															{new Date(
																segment.DepartureTimeEpochMs,
															).toLocaleString()}
														</p>
														<p>
															Arrival Time:{' '}
															{new Date(
																segment.ArrivalTimeEpochMs,
															).toLocaleString()}
														</p>
														<p>STL Distance: {segment.StlDistance}</p>
														<p>
															STL Fuel Consumption: {segment.StlFuelConsumption}
														</p>
														<p>FTL Distance: {segment.FtlDistance}</p>
														<p>
															FTL Fuel Consumption: {segment.FtlFuelConsumption}
														</p>
														<div className="ml-5">
